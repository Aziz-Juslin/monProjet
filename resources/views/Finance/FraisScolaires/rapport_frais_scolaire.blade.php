@extends('layouts.master1', ['title'=> 'Rapport Journalier de frais scolaires'])
@section('section')
...
@include('Finance.FraisScolaires.head_frais')
      ...
      <div class="row">
         <div class="col-md-3 ">
          <div  class="btn bg-orange-400 btn-block mt-1 rapport_frais">
            ...
            <div class="mt-2">
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  <select name="mois" class="form-control form-control-lg" >
      ...
      <div class="col-md-9">
        ...
        <div class="mb-3">
          <h6 class="mb-0 font-weight-semibold">
            Rapports Journalier de frais scolaires
        ...
        <div class="card-body">
               <div class="d-md-flex align-items-md-center flex-md-wrap text-center text-md-left">
                <ul class="list-inline list-inline-condensed mb-0">
                   <li class="list-inline-item"><a class="btn btn-link text-default"><i class="icon-statistics mr-2"></i> {{$datePaye->count()}}</a></li>
                </ul>
                    ...
                    <div class="d-sm-flex align-item-sm-center flex-sm-nowrap">
                      <div>
                        ...
                        <ul class="list list-unstyled mb-0">
                          <li>Rapport journalier de <b>Frais scolaire</b></li>
