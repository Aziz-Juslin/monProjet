<tr class="table-active table-border-double">
                    ...
                    <tr>
                      ...
                      <td><span class="text-muted">{{$nombreElevePayerAujourdhuiAutreFranc}}</span></td>
                      <td><span class="text-pink-600"><i class="icon-stats-growth2 mr-2"></i></span></td>
                      <td><h4 class="font-weight-semibold mb-0">{{$AutrefraispayerAujourdhuiEnFranc}} FC</h4></td>
                    ...
                    <tr>
                      ...
                      <td><span class="text-muted"> {{$nombreElevePayerAujourdhuiAutreDollar}}</span></td>
                      <td><span class="text-success-600"><i class="icon-stats-growth2 mr-2"></i> </span></td>
                      <td><h4 class="font-weight-semibold mb-0">{{$AutrefraispayerAujourdhuiEnDollar}} $</h4></td>
