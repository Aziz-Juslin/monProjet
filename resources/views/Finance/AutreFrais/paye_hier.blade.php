<tr class="table-active table-border-double">
                        ...
                        <div class="d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <div class="text-muted font-size-sm">
                              ...
                              {{\Carbon\Carbon::parse('1 day ago')->format('d/m/Y')}}
                            </div>
                          </div>
                        </div>
                      </td>
                      <td><span class="text-muted">{{$nombreElevePayerHierAutreFranc}}</span></td>
                      <td><span class="text-pink-600"><i class="icon-stats-growth2 mr-2"></i>Franc</span></td>
                      <td><h4 class="font-weight-semibold mb-0">{{$AutrefraispayerHierEnFranc}} CDF</h4></td>
                      <td><span class="badge bg-pink">Active</span></td>
                    ...
                    <tr>
                      ...
                      <td><span class="text-muted"> {{$nombreElevePayerHierAutreDollar}}</span></td>
                      <td><span class="text-success-600"><i class="icon-stats-growth2 mr-2"></i> </span></td>
                      <td><h4 class="font-weight-semibold mb-0">{{$AutrefraispayerHierEnDollar}} $</h4></td>
