<tr class="table-active table-border-double">
                    ...
                    <tr>
                      ...
                      <td><span class="text-muted">{{$nombreElevePayerFrancHier}}</span></td>
                      <td><span class="text-pink-600"><i class="icon-stats-growth2 mr-2"></i></span></td>
                      <td><h4 class="font-weight-semibold mb-0">{{$fraispayerHierEnFranc}} CDF</h4></td>
                    ...
                    <tr>
                      ...
                      <td><span class="text-muted"> {{$nombreElevePayerDollarHier}}</span></td>
                      <td><span class="text-success-600"><i class="icon-stats-growth2 mr-2"></i> </span></td>
                      <td><h4 class="font-weight-semibold mb-0">{{$fraispayerHierEnDollar}} $</h4></td>
